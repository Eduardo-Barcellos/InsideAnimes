...
<head>
    ...
    <title>Catalogo - InsideAnimes</title>
</head>
<body>
...
<header class="cabecario">
        ...
        <nav class="navegacao cabecaoff">
            <ul class="lista">
                ...
                <li class="item ativo"><a href="catalogo.php">Animes</a></li>
    ...
    <section class="menu2" id="#menu2">
        <div class="menu1">
            ...
            <nav class="navegacao2">
                <ul class="lista">
                    <li class="item"><a href="index.php">Home</a></li>
                    <li class="item"><a href="catalogo.php" class="ativo">Animes</a></li>
                    <li class="item"><a href="login.php">Login</a></li>
                </ul>
            </nav>
        </div>
    ...
    <main>
            ...
            <h1 class="titulo-principal">Catálogo de Animes</h1>


            <div class="catalogo-animes">
                
            <?php foreach($todosanimes as $anime):  ?>

                <a href="anime.php?id=<?php echo $anime["id"]; ?>">
                    <img src="img/<?php echo $anime['foto']; ?>.jpg" alt="">
                </a>
